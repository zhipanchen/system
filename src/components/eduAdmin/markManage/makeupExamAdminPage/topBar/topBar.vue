<template>
  <div id="makeupExam_topBar" class="topBarDiv am-btn-group">
    ...
    <button class="am-btn am-btn-success btn-active" @click="hrefClick(7)">补考审批</button>
  </div>
</template>

<script>
  export default {
    name: 'makeupExam_topBar',
    data () {
      return {
        msg: ''
      }
    ...
    mounted: function () {
      try{
        var buttons = document.getElementById("makeupExam_topBar").getElementsByTagName("button");
