<template>
  <div id="suspendCouApply_topBar" class="topBarDiv am-btn-group">
    ...
    <button class="am-btn am-btn-success btn-active" @click="hrefClick(4)">停课审批</button>
...
<script>
  export default {
    ...
    mounted: function() {
      try{
        var buttons = document.getElementById("suspendCouApply_topBar").getElementsByTagName("button");
